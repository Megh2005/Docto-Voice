...
export default function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative", className)}>
      <div
        className="group relative cursor-pointer max-w-6xl mx-auto mb-8"
        onClick={() => setIsVideoOpen(true)}
      >
        <div className="bg-gray-300 p-3 rounded-xl border-4 border-gray-400 shadow-xl">
          <img
            src={thumbnailSrc}
            alt={thumbnailAlt}
            width={2000}
          ...
          />
          <div className="absolute inset-3 flex scale-[0.9] items-center justify-center rounded-2xl transition-all duration-200 ease-out group-hover:scale-100">
